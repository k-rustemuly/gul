...
use App\Helpers\FieldTypes\ReferenceTable;
...
class Field{
    ...
    public $etalon = array(
        ...
        "on_update" => [
            "is_required" => false,
            "visibility" => "invisible" // visible, disabled
        ],
        "on_create" => [
            "is_required" => false,
            "visibility" => "invisible" // visible, disabled
     ...
     */
    public function minTime(?string $time = null)
    {
        $this->etalon["min_time"] = $time;
        return $this;
    }
     ...
     * @param string $time H:i
     */
    public function maxTime(?string $time = null)
    {
        $this->etalon["max_time"] = $time;
        return $this;
    }
    ...
    {
        if($this->model instanceof Reference || $this->model instanceof ReferenceTable) $this->etalon["reference_url"] = $reference_url;
        return $this;
    }
