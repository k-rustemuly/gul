...
class CreateRbMilitaryRank extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('rb_military_rank', function (Blueprint $table) {
            $table->engine = 'MyISAM';
            $table->id();
        ...
        DB::statement("ALTER TABLE rb_military_rank COMMENT = 'Воинское звание'");
    }
    ...
    {
        Schema::dropIfExists('rb_military_rank');
    }
}
