...
class CreateRbRate extends Migration
{
    /**
     * Run the migrations. 
     *
    ...
    public function up()
    {
        Schema::create('rb_rate', function (Blueprint $table) {
            $table->engine = 'MyISAM';
            $table->id();
        ...
        DB::statement("ALTER TABLE rb_rate COMMENT = 'Ставки'");
    }
